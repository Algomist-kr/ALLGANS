...
class LayeredVertexGraph10(AbstractModel):
    VERSION = 1.0
    AUTHOR = 'demetoir'
    ...
    def classifier(self, input_):
        ...
        with tf.variable_scope('classifier'):
            ...
            seq.add_layer(conv_block, 256, filter_3322, relu)
            ...
            seq.add_layer(conv_block, 512, filter_3322, relu)
